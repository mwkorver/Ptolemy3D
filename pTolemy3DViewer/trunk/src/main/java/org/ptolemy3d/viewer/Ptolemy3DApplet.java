...
public class Ptolemy3DApplet extends Applet implements Ptolemy3DJavascript,
	...
	{
		try {
			ptolemy.cameraController.setOrientation(LatLonAlt.fromDegrees(latitude, longitude, altitude),
					direction, pitch);
		}
	...
	public void setLongitude(double longitude)
	{
		try {
			...
			cameraController.setOrientation(LatLonAlt.fromDegrees(latLonAlt.getLatitudeDegrees(), longitude, latLonAlt.getAltitude()), 
	...
	public double getLongitude()
	{
		try {
			final Camera camera = ptolemy.camera;
			final LatLonAlt latLonAlt = camera.getLatAltLon();
			return latLonAlt.getLongitudeDegrees();
		} catch (Exception e) { IO.printStackJavascript(e); }
		return 0.0;
	}
	...
	public void setLatitude(double latitude)
	{
		try {
			...
			cameraController.setOrientation(LatLonAlt.fromDegrees(latitude, latLonAlt.getLongitudeDegrees(), latLonAlt.getAltitude()), 
					camera.getDirectionDegrees(), camera.getPitchDegrees());
		} catch (Exception e) { IO.printStackJavascript(e); }
	}
	...
	public double getLatitude()
	{
		try {
			final Camera camera = ptolemy.camera;
			final LatLonAlt latLonAlt = camera.getLatAltLon();
			return latLonAlt.getLatitudeDegrees();
		} catch (Exception e) { IO.printStackJavascript(e); }
		return 0.0;
	}
	...
	public void setAltitude(double altitude)
	{
		try {
			...
			cameraController.setOrientation(LatLonAlt.fromDegrees(latLonAlt.getLatitudeDegrees(), latLonAlt.getLongitudeDegrees(), altitude), 
					camera.getDirectionDegrees(), camera.getPitchDegrees());
		} catch (Exception e) { IO.printStackJavascript(e); }
	}
	...
	public double getAltitude()
	{
		try {
			final Camera camera = ptolemy.camera;
			final LatLonAlt latLonAlt = camera.getLatAltLon();
			return latLonAlt.getAltitude();	//FIXME use camera.altMeter ?
		} catch (Exception e) { IO.printStackJavascript(e); }
		return 0.0;
	}
	/**
	...
	public final double getAltitudeMeters()
	{
		try {
			final Camera camera = ptolemy.camera;
			final LatLonAlt latLonAlt = camera.getLatAltLon();
			return latLonAlt.getAltitudeDD();	//FIXME use camera.altMeter ?
		} catch (Exception e) { IO.printStackJavascript(e); }
		return 0.0;
	}
	/**
	...
	public void setDirection(double direction)
	{
		try {
			...
			cameraController.setOrientation(latLonAlt,
	...
	{
		try {
			ptolemy.cameraController.flyTo(LatLonAlt.fromDegrees(lat, lon, alt),
	...
	{
		try {
			ptolemy.cameraController.flyToPositionTime(LatLonAlt.fromDegrees(lat, lon, alt),
	...
	{
		try {
			ptolemy.cameraController.flyToPositionSpeed(LatLonAlt.fromDegrees(lat, lon, alt),
	 ...
	 * 5 Tile color is the tile id. (Landscape.DISPLAY_LEVELID)
	...
	{
		try {
			ptolemy.cameraController.panorama(LatLonAlt.fromDegrees(tz, tx, camht), rtimes, rspeed, rpitch);
		} catch (Exception e) { IO.printStackJavascript(e); }
	}
