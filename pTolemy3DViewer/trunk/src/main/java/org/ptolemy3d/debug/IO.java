			...
			switch(keyCode)
			{
				...
				case KeyEvent.VK_F5:
					switch(landscape.displayMode) {
						...
						case Landscape.DISPLAY_TILEID:    landscape.displayMode = Landscape.DISPLAY_LEVELID; break;
						case Landscape.DISPLAY_LEVELID:    landscape.displayMode = Landscape.DISPLAY_STANDARD; break;
					}
					break;
				case KeyEvent.VK_F8:
