...
class TileVARenderer extends TileDirectModeRenderer {
    ...
    protected final void drawDemSubsection_Textured(int x1, int z1, int x2, int z2) {
        final Level drawLevel = landscape.getLevels()[drawZlevel];
        ...
        for (int i = startz; i < endz; i++) {
            ...
            for (int j = startx; j < endx; j++) {
                ...
                uvArray[uvArrayPointer] = tex_x;
                uvArrayPointer++;
                uvArray[uvArrayPointer] = tex_z;
                uvArrayPointer++;
                vertexArray[vertexArrayPointer] = cx1;
                vertexArrayPointer++;
                vertexArray[vertexArrayPointer] = cy1;
                vertexArrayPointer++;
                vertexArray[vertexArrayPointer] = cz1;
                vertexArrayPointer++;

                uvArray[uvArrayPointer] = tex_x;
                uvArrayPointer++;
                uvArray[uvArrayPointer] = tex_z2;
                uvArrayPointer++;
                vertexArray[vertexArrayPointer] = cx2;
                vertexArrayPointer++;
                vertexArray[vertexArrayPointer] = cy2;
                vertexArrayPointer++;
                vertexArray[vertexArrayPointer] = cz2;
                vertexArrayPointer++;
        ...
        vertexBuffer.put(vertexArray, 0, vertexArrayPointer).rewind();
        vertexArrayPointer = 0;
        uvBuffer.put(uvArray, 0, uvArrayPointer).rewind();
        uvArrayPointer = 0;
    ...
    protected final void drawSubsection_Textured(int x1, int z1, int x2, int z2) {
        ...
        for (int j = 0; j < n; j++) {
            ...
            for (int i = 0; i <= n; i++) {
                ...
                uvArray[uvArrayPointer] = tx;
                uvArrayPointer++;
                uvArray[uvArrayPointer] = ty1;
                uvArrayPointer++;
                vertexArray[vertexArrayPointer] = cx1;
                vertexArrayPointer++;
                vertexArray[vertexArrayPointer] = cy1;
