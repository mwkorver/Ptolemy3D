...
/**
 * Events related to the initialization, rendering and destruction of 3D/OpenGL related code.
 */
public class Ptolemy3DEvents implements GLEventListener, Transferable
{
	...
	/** Width of the frame buffer, can be different to screen in case of an offscreen rendering. */
	public int drawWidth = 0;
	/** Height of the frame buffer, can be different to screen in case of an offscreen rendering. */
	 ...
	 * To stop and clean up OpenGL datas, when exiting, use <code>ON</code> flag and wait while rendering thread is alive.
	 * @see #renderingLoopOn
