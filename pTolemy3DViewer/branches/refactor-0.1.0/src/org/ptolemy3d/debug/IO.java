			...
			switch(keyCode)
			{
				...
				case KeyEvent.VK_F5:
					switch(landscape.getDisplayMode()) {
						case Landscape.DISPLAY_STANDARD:  landscape.setDisplayMode(Landscape.DISPLAY_MESH); break;
						case Landscape.DISPLAY_MESH:      landscape.setDisplayMode(Landscape.DISPLAY_SHADEDDEM); break;
						case Landscape.DISPLAY_SHADEDDEM: landscape.setDisplayMode(Landscape.DISPLAY_JP2RES); break;
						case Landscape.DISPLAY_JP2RES:    landscape.setDisplayMode(Landscape.DISPLAY_TILEID); break;
						case Landscape.DISPLAY_TILEID:    landscape.setDisplayMode(Landscape.DISPLAY_LEVELID); break;
						case Landscape.DISPLAY_LEVELID:    landscape.setDisplayMode(Landscape.DISPLAY_STANDARD); break;
					}
					break;
				case KeyEvent.VK_F8:
