...
public class InputListener implements KeyListener, MouseListener,
	...
	/**
	 * Mouse moving flag, used to know when mousePressed event have been
	 * triggered.
	 */
...
//			if (SwingUtilities.isLeftMouseButton(e)) {
				if (cameraController.fmode == 0) {
					...
					cameraController.lr_rot_velocity += (mousePoint.x - oldMousePoint.x)
							* -(rot_accel);
					cameraController.ud_rot_velocity += (mousePoint.y - oldMousePoint.y)
							* (rot_accel);
				}
//			}
			
//			// If RIGHTmouse button pressed			
