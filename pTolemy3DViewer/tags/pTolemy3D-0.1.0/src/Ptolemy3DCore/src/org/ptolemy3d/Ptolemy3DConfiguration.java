...
public class Ptolemy3DConfiguration
{
	...
	public void loadSettings(Element docelem)
	{
		...
		{
			serverKeys = new String[nDataServers];
			...
			for (int i = 1; i <= nDataServers; i++)
			{
				...
				{
					ptok = new StringTokenizer(temppm, ",");
		...
		for (int i = 0; i < NumLevels; i++)
		{
			...
			temppm = getXmlParameter("LayerDIVIDER_" + (i + 1), docelem);
