...
public class Matrix16d {
	...
	public final void multiply(Matrix16d matrix) {
		...
		m12 = matrix.m[12] * this.m[0] + matrix.m[13] * this.m[4] + matrix.m[14] * this.m[8] + matrix.m[15]
				* this.m[12];
		m13 = matrix.m[12] * this.m[1] + matrix.m[13] * this.m[5] + matrix.m[14] * this.m[9] + matrix.m[15]
				* this.m[13];
		m14 = matrix.m[12] * this.m[2] + matrix.m[13] * this.m[6] + matrix.m[14] * this.m[10] + matrix.m[15]
				* this.m[14];
		m15 = matrix.m[12] * this.m[3] + matrix.m[13] * this.m[7] + matrix.m[14] * this.m[11] + matrix.m[15]
				* this.m[15];
	...
	public final double determinant3x3() {
		return (m[0] * m[5] - m[1] * m[4]) * m[10] - (m[0] * m[6] - m[2] * m[4]) * m[9] + (m[1] * m[6] - m[2] * m[5])
				* m[8];
	}
